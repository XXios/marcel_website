      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-foreground-muted text-sm leading-relaxed max-w-xs">
              Ihr Maler & Gestalter im Landkreis Bamberg. Qualität, Sauberkeit
              und Termintreue {"–"} darauf können Sie sich verlassen.
            </p>
          </div>
        ...
        <div className="py-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-foreground-muted/50 text-xs">
            &copy; {currentYear} Maler & Gestalter Vogel. Alle Rechte
            vorbehalten.
          </p>
          <p className="text-foreground-muted/80 text-xs">
            Diese Seite wurde erstellt von {/* Open in new tab */}
            <a
              href="https://www.xiosdev.de"
